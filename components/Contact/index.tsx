                ...
                <div className="flex flex-wrap gap-4 xl:justify-between ">
                  <div className="mb-4 flex md:mb-0">
                    <input
                      ...
                      required
                    />
                    <span className="border-gray-300 bg-gray-100 text-blue-600 dark:border-gray-600 dark:bg-gray-700 group mt-2 flex h-5 min-w-[20px] items-center justify-center rounded-sm border-2 peer-checked:bg-primary peer-checked:border-primary dark:peer-checked:bg-primary dark:peer-checked:border-primary">
                      <svg
                        className="opacity-0 peer-checked:opacity-100 fill-white"
                        width="10"
                        height="8"
                        viewBox="0 0 10 8"
                        fill="none"
